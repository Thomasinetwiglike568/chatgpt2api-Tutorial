...
2. If a window appears that says "Windows protected your PC," click the text labeled "More info."
3. A new button labeled "Run anyway" will appear. Click this button to proceed.
4. Follow the on-screen instructions in the setup wizard.
5. Click "Next" through the prompts to keep the settings at their defaults.
6. Click "Install" to place the application in your program files.
...
1. Type a description of the image you want into the text box. Be specific about the subject, the style, and the colors. For example, you might type "A futuristic city at sunset with neon lights."
2. Press the "Generate" button.
3. Wait a few moments while the system processes your request through the adapter.
4. The image will appear in the main window of the application.
